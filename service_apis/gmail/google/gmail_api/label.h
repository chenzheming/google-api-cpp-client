...
#include "google/gmail_api/label_color.h"
...
class Label : public client::JsonCppData {
 public:
  ...
  /**
   * Determine if the '<code>color</code>' attribute was set.
   *
   * @return true if the '<code>color</code>' attribute was set.
   */
  bool has_color() const {
    return Storage().isMember("color");
  }

  /**
   * Clears the '<code>color</code>' attribute.
   */
  void clear_color() {
    MutableStorage()->removeMember("color");
  }


  /**
   * Get a reference to the value of the '<code>color</code>' attribute.
   */
  const LabelColor get_color() const;

  /**
   * Gets a reference to a mutable value of the '<code>color</code>' property.
   *
